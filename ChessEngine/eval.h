...
namespace eval {
	...
	constexpr int pawnValueStart = 82;
	constexpr int pawnValueEnd = 94;
	constexpr int knightValueStart = 337;
	constexpr int knightValueEnd = 281;
	constexpr int bishopValueStart = 365;
	constexpr int bishopValueEnd = 297;
	constexpr int rookValueStart = 477;
	constexpr int rookValueEnd = 512;
	constexpr int queenValueStart = 1025;
	constexpr int queenValueEnd = 936;
	...
	static std::array<int, 64> pawnBonusesStart = {
	  0,   0,   0,   0,   0,   0,  0,   0,
	...
	static std::array<int, 64> pawnBonusesEnd = {
	  0,   0,   0,   0,   0,   0,   0,   0,
	...
	static std::array<int, 64> knightBonusesStart = {
	...
	static std::array<int, 64> knightBonusesEnd = {
	...
	static std::array<int, 64> bishopBonusesStart = {
	...
	static std::array<int, 64> bishopBonusesEnd = {
	...
	static std::array<int, 64> rookBonusesStart = {
	...
	static std::array<int, 64> rookBonusesEnd = {
	...
	static std::array<int, 64> queenBonusesStart = {
	...
	static std::array<int, 64> queenBonusesEnd = {
	...
	static std::array<int, 64> kingBonusesStart = {
	...
	static std::array<int, 64> kingBonusesEnd = {
	...
	//											    1  2   3   4   5   6   7
	static std::array<int, 7> passedPawnBonuses = { 0, 10, 20, 40, 60, 80, 0 };
